...
<form class="form2"id="frmadd" name="frmadd"action="<?php echo base_url('welcome/cruds/'.$hash);?>" method="post" enctype="multipart/form-data">
   ...
   <a href="javascript:void(0);" class="modal-action modal-close waves-effect waves-green btn red">Agree</a>
</form>
<?php else:?>
...
<?php 
   $str = $edit_event['event_name'];
   $names = explode(" ",$str);?>

<div class="input-fiel col s12 m5">
<label for="first_name">First Name</label>
<input require readonly id="first_name" name="first_name"type="text" class="validate" value="">
</div>
<div class="input-fiel col s12 m5">
<label for="last_name">Last Name</label>
<input readonly placeholder="asdasdasd"require id="last_name" name="last_name" type="text" class="validate" value="">
</div>
<div class="input-fiel col s12 m2">
<label>Extension</label>
<input require name="extension"placeholder="Extension"class="validate"list="extensions" value="">
<datalist id="extensions">
<option value="Jr">
<option value="Sr">
<option value="II">
